...
const SalesOrderForm = ({ order, onClose, onSuccess }) => {
  ...
  const onSubmit = (data) => {
    const orderData = {
      ...data,
      so_number: isEditing ? order.so_number : generateSONumber(),
      status: 'draft',
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                type="text"
                value={isEditing ? order.so_number : 'Auto Generated'}
                disabled
          ...
          <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
            ...
            <button type="submit" className="btn-primary">
              {isEditing ? 'Update Order' : 'Create Sales Order'}
            </button>
          </div>
        </form>
      </div>
